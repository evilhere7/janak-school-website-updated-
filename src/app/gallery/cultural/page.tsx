...
export default function CulturalGalleryPage() {
  ...
  const items = GALLERY_ITEMS.filter((i) => i.category.toLowerCase() === "cultural");
      ...
      <section className="relative hero-gradient text-white py-20 sm:py-28 overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="font-display font-black text-3xl sm:text-5xl tracking-tight text-white mb-4">
            Cultural Programs & Performing Arts
          </h1>
          <p className="text-white/80 text-base max-w-xl mx-auto">
            Traditional Nepalese folk dances, musical festivals, and dramatic presentations.
          </p>
        </div>
      </section>
